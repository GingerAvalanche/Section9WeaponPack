...
static function SetUpSection9ClipSizeUpgrade(out X2WeaponUpgradeTemplate Template)
{
	...
	Template.AddUpgradeAttachment('Mag', 'UIPawnLocation_WeaponUpgrade_AssaultRifle_Mag', "S9_SEBUROPACK.Mesh.SEBC30_expmag_loader", "", 'RIF_SEBC30_CV', , "img:///S9_SEBUROPACK.img.SEBC30_expmag_loader", "img:///S9_SEBUROPACK.img.SEBC30_expmag_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_clip", ReloadUpgradePresent);
	Template.AddUpgradeAttachment('Mag', 'UIPawnLocation_WeaponUpgrade_AssaultRifle_Mag', "S9_SEBUROPACK.Mesh.SEBC30_expmag_loader", "", 'RIF_SEBC30_MG', , "img:///S9_SEBUROPACK.img.SEBC30_expmag_loader", "img:///S9_SEBUROPACK.img.SEBC30_expmag_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_clip", ReloadUpgradePresent);
	Template.AddUpgradeAttachment('Mag', 'UIPawnLocation_WeaponUpgrade_AssaultRifle_Mag', "S9_SEBUROPACK.Mesh.SEBC30_expmag_loader", "", 'RIF_SEBC30_BM', , "img:///S9_SEBUROPACK.img.SEBC30_expmag_loader", "img:///S9_SEBUROPACK.img.SEBC30_expmag_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_clip", ReloadUpgradePresent);
...
static function SetUpSection9FreeFireUpgrade(out X2WeaponUpgradeTemplate Template)
{
	//Parameters: Name AttachSocket, Name UIArmoryCameraPointTag, string MeshName, string ProjectileName, name MatchWeaponTemplate, optional bool AttachToPawn, optional string IconName, optional string InventoryIconName, optional string InventoryCategoryIcon, optional delegate<X2TacticalGameRulesetDataStructures.CheckUpgradeStatus> ValidateAttachmentFn
	// Assault Rifles
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_AssaultRifle_Mag', "S9_SEBUROPACK.Mesh.SEBC30_hairtrigger", "", 'RIF_SEBC30_CV', , "img:///S9_SEBUROPACK.img.SEBC30_hairtrigger", "img:///S9_SEBUROPACK.img.SEBC30_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_AssaultRifle_Mag', "S9_SEBUROPACK.Mesh.SEBC30_hairtrigger", "", 'RIF_SEBC30_MG', , "img:///S9_SEBUROPACK.img.SEBC30_hairtrigger", "img:///S9_SEBUROPACK.img.SEBC30_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_AssaultRifle_Mag', "S9_SEBUROPACK.Mesh.SEBC30_hairtrigger", "", 'RIF_SEBC30_BM', , "img:///S9_SEBUROPACK.img.SEBC30_hairtrigger", "img:///S9_SEBUROPACK.img.SEBC30_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
		
	// Shotguns
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Shotgun_Stock', "S9_SEBUROPACK.Mesh.KSGG1_hairtrigger", "", 'SG_KSGG1_CV', , "img:///S9_SEBUROPACK.img.KSGG1_hairtrigger", "img:///S9_SEBUROPACK.img.KSGG1_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Shotgun_Stock', "S9_SEBUROPACK.Mesh.KSGG1_hairtrigger", "", 'SG_KSGG1_MG', , "img:///S9_SEBUROPACK.img.KSGG1_hairtrigger", "img:///S9_SEBUROPACK.img.KSGG1_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Shotgun_Stock', "S9_SEBUROPACK.Mesh.KSGG1_hairtrigger", "", 'SG_KSGG1_BM', , "img:///S9_SEBUROPACK.img.KSGG1_hairtrigger", "img:///S9_SEBUROPACK.img.KSGG1_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");

	// Cannons
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Cannon_Stock', "S9_SEBUROPACK.Mesh.SEBMG_hairtrigger", "", 'MG_SEBMG_CV', , "img:///S9_SEBUROPACK.img.SEBMG_hairtrigger", "img:///S9_SEBUROPACK.img.SEBMG_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Cannon_Stock', "S9_SEBUROPACK.Mesh.SEBMG_hairtrigger", "", 'MG_SEBMG_MG', , "img:///S9_SEBUROPACK.img.SEBMG_hairtrigger", "img:///S9_SEBUROPACK.img.SEBMG_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Cannon_Stock', "S9_SEBUROPACK.Mesh.SEBMG_hairtrigger", "", 'MG_SEBMG_BM', , "img:///S9_SEBUROPACK.img.SEBMG_hairtrigger", "img:///S9_SEBUROPACK.img.SEBMG_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	
	// Sniper Rifles
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Sniper_Mag', "S9_SEBUROPACK.Mesh.SEBSR_hairtrigger", "", 'SR_SEBSR_CV', , "img:///S9_SEBUROPACK.img.SEBSR_hairtrigger", "img:///S9_SEBUROPACK.img.SEBSR_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Sniper_Mag', "S9_SEBUROPACK.Mesh.SEBSR_hairtrigger", "", 'SR_SEBSR_MG', , "img:///S9_SEBUROPACK.img.SEBSR_hairtrigger", "img:///S9_SEBUROPACK.img.SEBSR_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Sniper_Mag', "S9_SEBUROPACK.Mesh.SEBSR_hairtrigger", "", 'SR_SEBSR_BM', , "img:///S9_SEBUROPACK.img.SEBSR_hairtrigger", "img:///S9_SEBUROPACK.img.SEBSR_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");

	// SMGs
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Shotgun_Stock', "S9_SEBUROPACK.Mesh.SEBC26A_hairtrigger", "", 'SMG_SEBC26A_CV', , "img:///S9_SEBUROPACK.img.SEBC26A_hairtrigger", "img:///S9_SEBUROPACK.img.SEBC26A_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Shotgun_Stock', "S9_SEBUROPACK.Mesh.SEBC26A_hairtrigger", "", 'SMG_SEBC26A_MG', , "img:///S9_SEBUROPACK.img.SEBC26A_hairtrigger", "img:///S9_SEBUROPACK.img.SEBC26A_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
	Template.AddUpgradeAttachment('Trigger', 'UIPawnLocation_WeaponUpgrade_Shotgun_Stock', "S9_SEBUROPACK.Mesh.SEBC26A_hairtrigger", "", 'SMG_SEBC26A_BM', , "img:///S9_SEBUROPACK.img.SEBC26A_hairtrigger", "img:///S9_SEBUROPACK.img.SEBC26A_hairtrigger_inv", "img:///UILibrary_StrategyImages.X2InventoryIcons.Inv_weaponIcon_trigger");
}
